...
public class Demo1 {
	...
	public static void main(String[] args) throws IOException {
		//locate excel file
		FileInputStream files = new FileInputStream("D:\\Tech Bodhi Course\\Automation Testing\\Excel sheet demo.xlsx");
		XSSFWorkbook workbook = new XSSFWorkbook(files);//To read excel
		XSSFSheet sheet = workbook.getSheet("Employee details");//to read sheet
